...
const BottomNav = () => {
  ...
  return (
    <div className="fixed flex justify-around items-center w-full bottom-0 text-black dark:text-white bg-body-bg dark:bg-body-bg-dark h-12 border-t border-gray-300 dark:border-gray-800">
      {[
        { to: "/", icon: HomeIcon },
