...
const ChatStack = () => {
  ...
  return (
    <div className="flex w-full h-full">
      {isInboxRoute ? (
        <>
          <div className="w-full lg:w-1/2 lg:border-r border-gray-300 dark:border-gray-800">
            <Inbox />
          </div>
        ...
        <>
          <div className="w-full hidden lg:w-1/2 lg:block lg:border-r border-gray-300 dark:border-gray-800">
            <Inbox />
          </div>
